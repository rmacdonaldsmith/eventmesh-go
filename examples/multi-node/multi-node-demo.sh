...
if [ $RUNNING_NODES -eq 3 ]; then
    ...
    echo ""
    echo "# Publish to Node1:"
    echo "EVENTMESH_SERVER=http://localhost:8091 ./publisher.sh"
    echo ""
    echo "# Stream from Node1:"
    echo "EVENTMESH_SERVER=http://localhost:8091 ./subscriber.sh"
    echo ""
    echo "# Publish directly with curl:"
