...
// Provides logical separation between data-plane user events and control-plane
// coordination messages while sharing one EventStream transport.
...
type PeerMessage_ControlPlane struct {
	ControlPlane *ControlPlaneMessage `protobuf:"bytes,5,opt,name=control_plane,json=controlPlane,proto3,oneof"` // Control plane: topic-interest gossip
}
...
// Control plane message wrapper for topic-interest gossip and other mesh coordination.
// Control-plane frames are never user events, even though they share the same
// physical EventStream as data-plane frames.
type ControlPlaneMessage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Kind:
	//
	//	*ControlPlaneMessage_InterestUpdate
	//	*ControlPlaneMessage_InterestSnapshot
...
func (x *ControlPlaneMessage) Reset() {
	*x = ControlPlaneMessage{}
	mi := &file_proto_peerlink_v1_peerlink_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ControlPlaneMessage) Descriptor() ([]byte, []int) {
	return file_proto_peerlink_v1_peerlink_proto_rawDescGZIP(), []int{5}
}
...
func (x *ControlPlaneMessage) GetInterestUpdate() *InterestUpdate {
	if x != nil {
		if x, ok := x.Kind.(*ControlPlaneMessage_InterestUpdate); ok {
			return x.InterestUpdate
		}
	}
	return nil
}

func (x *ControlPlaneMessage) GetInterestSnapshot() *InterestSnapshot {
	if x != nil {
		if x, ok := x.Kind.(*ControlPlaneMessage_InterestSnapshot); ok {
			return x.InterestSnapshot
		}
	}
	return nil
}
...
type ControlPlaneMessage_InterestUpdate struct {
	InterestUpdate *InterestUpdate `protobuf:"bytes,1,opt,name=interest_update,json=interestUpdate,proto3,oneof"` // Aggregate node-level interest delta
}

type ControlPlaneMessage_InterestSnapshot struct {
	InterestSnapshot *InterestSnapshot `protobuf:"bytes,2,opt,name=interest_snapshot,json=interestSnapshot,proto3,oneof"` // Complete aggregate node-level interest snapshot
}

func (*ControlPlaneMessage_InterestUpdate) isControlPlaneMessage_Kind() {}

func (*ControlPlaneMessage_InterestSnapshot) isControlPlaneMessage_Kind() {}

// Aggregate topic-interest delta for peer-to-peer gossip.
// Peers gossip node-level topic interest, not individual client subscriptions.
type InterestUpdate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodeId        string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"` // ID of the node where aggregate interest changed
	Action        string                 `protobuf:"bytes,2,opt,name=action,proto3" json:"action,omitempty"`               // "subscribe" or "unsubscribe"
	Topic         string                 `protobuf:"bytes,3,opt,name=topic,proto3" json:"topic,omitempty"`                 // Topic pattern whose aggregate interest changed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *InterestUpdate) Reset() {
	*x = InterestUpdate{}
	mi := &file_proto_peerlink_v1_peerlink_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InterestUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InterestUpdate) ProtoMessage() {}

func (x *InterestUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_proto_peerlink_v1_peerlink_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InterestUpdate.ProtoReflect.Descriptor instead.
func (*InterestUpdate) Descriptor() ([]byte, []int) {
	return file_proto_peerlink_v1_peerlink_proto_rawDescGZIP(), []int{6}
}

func (x *InterestUpdate) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *InterestUpdate) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
func (x *InterestUpdate) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
// Complete aggregate topic-interest snapshot for peer-to-peer gossip.
// Receivers replace their entire stored view for node_id with topics.
type InterestSnapshot struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodeId        string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"` // ID of the node sending its current aggregate interest view
	Topics        []string               `protobuf:"bytes,2,rep,name=topics,proto3" json:"topics,omitempty"`               // Current aggregate topic patterns with local interest
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *InterestSnapshot) Reset() {
	*x = InterestSnapshot{}
	mi := &file_proto_peerlink_v1_peerlink_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InterestSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InterestSnapshot) ProtoMessage() {}

func (x *InterestSnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_proto_peerlink_v1_peerlink_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InterestSnapshot.ProtoReflect.Descriptor instead.
func (*InterestSnapshot) Descriptor() ([]byte, []int) {
	return file_proto_peerlink_v1_peerlink_proto_rawDescGZIP(), []int{7}
}

func (x *InterestSnapshot) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *InterestSnapshot) GetTopics() []string {
	if x != nil {
		return x.Topics
	}
	return nil
...
const file_proto_peerlink_v1_peerlink_proto_rawDesc = "" +
	"\n" +
	" proto/peerlink/v1/peerlink.proto\x12\vpeerlink.v1\"\xa0\x02\n" +
	"\vPeerMessage\x126\n" +
	...
	"\tHeartbeat\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\"\xb3\x01\n" +
	"\x13ControlPlaneMessage\x12F\n" +
	"\x0finterest_update\x18\x01 \x01(\v2\x1b.peerlink.v1.InterestUpdateH\x00R\x0einterestUpdate\x12L\n" +
	"\x11interest_snapshot\x18\x02 \x01(\v2\x1d.peerlink.v1.InterestSnapshotH\x00R\x10interestSnapshotB\x06\n" +
	"\x04kind\"W\n" +
	"\x0eInterestUpdate\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12\x16\n" +
	"\x06action\x18\x02 \x01(\tR\x06action\x12\x14\n" +
	"\x05topic\x18\x03 \x01(\tR\x05topic\"C\n" +
	"\x10InterestSnapshot\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12\x16\n" +
	"\x06topics\x18\x02 \x03(\tR\x06topics2Q\n" +
	"\bPeerLink\x12E\n" +
...
var file_proto_peerlink_v1_peerlink_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_proto_peerlink_v1_peerlink_proto_goTypes = []any{
	...
	(*InterestUpdate)(nil),      // 6: peerlink.v1.InterestUpdate
	(*InterestSnapshot)(nil),    // 7: peerlink.v1.InterestSnapshot
	nil,                         // 8: peerlink.v1.Event.HeadersEntry
}
var file_proto_peerlink_v1_peerlink_proto_depIdxs = []int32{
	...
	8, // 5: peerlink.v1.Event.headers:type_name -> peerlink.v1.Event.HeadersEntry
	6, // 6: peerlink.v1.ControlPlaneMessage.interest_update:type_name -> peerlink.v1.InterestUpdate
	7, // 7: peerlink.v1.ControlPlaneMessage.interest_snapshot:type_name -> peerlink.v1.InterestSnapshot
	0, // 8: peerlink.v1.PeerLink.EventStream:input_type -> peerlink.v1.PeerMessage
	0, // 9: peerlink.v1.PeerLink.EventStream:output_type -> peerlink.v1.PeerMessage
...
func file_proto_peerlink_v1_peerlink_proto_init() {
	...
	file_proto_peerlink_v1_peerlink_proto_msgTypes[5].OneofWrappers = []any{
		(*ControlPlaneMessage_InterestUpdate)(nil),
		(*ControlPlaneMessage_InterestSnapshot)(nil),
	}
	type x struct{}
