...
`GET /api/v1/admin/stats` is the primary routing/interest debugging surface. It
reports local subscription counts, deduplicated local interest topics, this
node's peer-interest view grouped by peer ID, and aggregate interest gossip
